...
Average_percentage= (Percentage_in_English+Percentage_in_History+Percentage_in_Math+Percentage_in_Science+Percentage_in_Sports)/5
Average_Marks=(Obtained_marks_in_English+Obtained_marks_in_History+Obtained_marks_in_Math+Obtained_marks_in_Science+Obtained_marks_in_Sports)/5
...
print(f"The average of your percentages is {Average_percentage}%")
print(f"The average of your marks is {Average_Marks}")